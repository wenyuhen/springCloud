...
public class DemoAspect {
    //切入点
    @Pointcut(value = "@annotation(com.example.demo.common.interfaces.Demo)")
    ...
    public Object around(ProceedingJoinPoint point, Demo myLog) {

        System.out.println("++++执行了around方法++++");

        String requestUrl = myLog.demo();
    ...
    public Object afterReturning(JoinPoint joinPoint, Demo myLog, Object result) {
...
//        HttpSession session = request.getSession();
    ...
    public void afterThrowing(JoinPoint joinPoint, Demo myLog, Exception ex) {
        System.out.println("++++执行了afterThrowing方法++++");
        System.out.println("请求：" + myLog.demo() + " 出现异常");
    }
